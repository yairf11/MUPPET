...
class Batcher(object):
    ...
    def batch_sentences(self, sentences: List[List[str]]):
        ...
        for k, sent in enumerate(sentences):
            ...
            # except:
            #     print(f"char_without_mask shape: {char_ids_without_mask.shape}")
            #     print(f"X_char shape: {X_char_ids.shape}")
            #     print(f"X_char specific shape: {X_char_ids[k, :length, :].shape}")
            #     print(f"sent: #{sent}#")
